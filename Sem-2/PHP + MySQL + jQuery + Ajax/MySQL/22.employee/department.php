...
<body>
  ...
  <div style="text-align: center; font-size: 125%; margin: 2% 0px;">
    <a href="department_new.php">New Department</a>
  </div>
  <?php
  $query = "select * from department";
  $records  = mysqli_query($mysqli, $query);
  ?>
  <form action="department_mysqli.php" method="post">
    <table border="2px" align="center" style="font-size: 125%; text-align: center;">
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($records)) {
          ...
          echo "<td><a href='department_update.php?id=" . $row['id'] . "'>Update</a></td>";
          echo "</tr>";
        }
        ?>
        <tr>
