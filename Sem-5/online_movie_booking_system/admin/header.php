        ...
        <nav class="navbar navbar-expand-md navbar-dark py-1" style="background-color: #A0C49D;">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav" style="display: flex;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link" href="dashboard.php" onmouseover="this.style.color=`yellow`" onmouseout="this.style.color=`white`" style="color: white !important;">Dashboard</a>
                    </li>
                    <li class="nav-item">
